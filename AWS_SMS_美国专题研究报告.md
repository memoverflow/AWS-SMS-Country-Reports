...
| 费用项目 | 一次性费用 | 月度费用 | 备注 |
|---------|-----------|---------|------|
| 专用短码（Short Code） | $650 | $995 | 个性化短码月度 $1,500；预置约 12 周 |
| Toll-Free 号码 | $0 | $2 | 注册周期约 15 个工作日 |
| 10DLC 号码 | $0 | $1/号码 | 需完成 10DLC 注册流程 |
...
### 4.2 第一步：Brand Registration（品牌注册）
...
### 4.3 第二步：Brand Vetting（品牌审核，强烈推荐）
...
### 4.4 第三步：Campaign Registration（Campaign 注册）
...
### 4.5 第四步：Number Association（号码关联）
...
### 7.4 号码去活报告（Deactivation Reports）
