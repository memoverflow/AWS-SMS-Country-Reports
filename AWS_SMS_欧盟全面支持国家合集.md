...
| 国家 | 号码类型 | 一次性费用 | 月度费用 | 预置时间 |
|------|---------|-----------|---------|---------|
| DE | 短码 | $2,400 | $1,600 | 12周 |
| IT | 短码 | 需 Support Case | 需 Support Case | — |
| IT | 长码 | — | $30 | 3周 |
| ES | 短码 | $372 | $591 | 12周 |
| ES | 长码 | — | $20 | 1周 |
| AT | 短码 | 需 Support Case | 需 Support Case | — |
| AT | 长码 | — | $27 | 2周 |
| PT | 短码 | 需 Support Case | 需 Support Case | — |
| PT | 长码 | — | $25 | 1周 |
| RO | 短码 | 需 Support Case | 需 Support Case | — |
| FI | 短码 | $1,733 | $319 | 5周 |
| FI | 长码 | — | $15 | 3周 |
| NL | 短码 | $2,938 | $2,400 | 4周 |
| NL | 长码 | — | $13 | 1周 |
| SE | 短码 | 需 Support Case | 需 Support Case | — |
| SE | 长码 | — | $10 | 1周 |
...
### 5.3 Case Description 模板（适用于所有 9 国）
