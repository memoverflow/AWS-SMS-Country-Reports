...
### 3.1 法国 (FR, +33) — Sender ID 不可含破折号，不支持长码
...
### 3.4 丹麦 (DK, +45) — 不支持短码，Robinson 列表
...
### 3.10 瑞士 (CH, +41) — 仅支持 Sender ID，不支持双向
...
### 4.4 Support Case 填写指南（长码，如需手动申请）
